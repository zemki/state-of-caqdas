...
- improve validity and reliability of the methodology
...
These conventions are fundamental to the quality of the data, code and
the project's overall sustainability but also intend to prevent
common mistakes that may arise during contributions.
...
At the very first there should be either an issue or a discussion
prepending your active contribution.
...
Then you need to clone or download the repository into your local environment.

### Create a new branch

You should always start your contribution by creating a new branch, coming from
...
> code quality checks and tests and your contribution 
> or changes are well documented.
...
> Keep in mind our goal of the review is to ensure the
> quality your contribution and not to criticise you.
